...
struct ConstantsStrings {
    ...
    static let errorPageMessage: String = "We didn't find the repository you are looking for. Please try another one."
    static let homeNavigationTitle: String = "Welcome to GH"
    static let createdAt: String = "Created on:"
    static let updatedAt: String = "Updated on:"
}
